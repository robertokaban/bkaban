...
description: "kaban.my.id do not use cookies and we do not collect any personal data."
...
__TLDR__: kaban.my.id do not use cookies and we do not collect any personal data.
...
We run [Google Analytics](https://analytics.google.com/) analytics on kaban.my.id. The following information is collected:

- __Page URL__. We track the page URL of each page view on this website. We use this to understand which pages have been viewed and how many times a particular page has been viewed. For example: _kaban.my.id_.
...
- __Visitor Country__. We look up the visitor’s country using the IP address. We do not track anything more granular than the country of origin and the IP address of the visitor is discarded. We never store IP addresses in our database or logs. 
